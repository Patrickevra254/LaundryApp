...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Tolbeel Sign In | Sign Up</title>
...
<body>
            ...
            <div class="brand-hero">
                ...
                <div class="mock-card">
                    <div class="mock-card-header">
                        ...
                        <div class="mock-dot" style="background:#fde68a"></div>
                        <div class="mock-dot" style="background:#fca5a5"></div>
                        <span style="font-size:.72rem; color:rgba(255,255,255,.5); margin-left:.4rem;">Recent
                            Orders</span>
                    </div>
                    <div class="mock-row">
                        <span>Chinwe A. – 3 items</span>
                ...
                <div id="loginForm">
                    ...
                    <form method="POST" action="{{ route('login.store') }}">
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-wrap">
                                <i class="fa fa-lock field-icon"></i>
                                <input type="password" name="password" id="loginPassword" class="field-input"
                        ...
                        <div class="form-row-split">
                            ...
                            <button type="button" class="forgot-link"
                                ...
                                onclick="switchScreen('forgot')">Forgot password?</button>
                        </div>
                ...
                <div id="registerForm" class="d-none">
                    ...
                    <form method="POST" action="{{ route('register.store') }}">
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-wrap">
                                <i class="fa fa-user field-icon"></i>
                                <input type="text" name="name" class="field-input" placeholder="John Doe"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-wrap">
                                <i class="fa fa-location-dot field-icon"></i>
                                <input type="text" name="address" class="field-input" placeholder="123 Main St"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-wrap">
                                <i class="fa fa-lock field-icon"></i>
                                <input type="password" name="password" id="registerPassword" class="field-input"
                                    placeholder="Create password" required>
                                <button type="button" class="pw-eye" onclick="togglePw('registerPassword', this)"><i
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-wrap">
                                ...
                                <button type="button" class="pw-eye" onclick="togglePw('confirmPassword', this)"><i
                                        class="fa fa-eye"></i></button>
                            </div>
                        </div>
    ...
    <script>
        ...
        // ── Fire toasts from Laravel session/errors ───────────────────────────────
        @if (session('success'))
        ...
        // ── Show correct screen on page load ─────────────────────────────────────
        @if (session('status'))
            switchScreen('forgotSent');
            showToast('success', 'Email Sent', @json(session('status')));
        @elseif ($errors->any() && old('name'))
            switchScreen('register');
        @elseif ($errors->any() && old('email') && !old('name'))
            switchScreen('forgot');
