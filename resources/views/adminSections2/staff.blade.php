{{-- <div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
        <div>
            <div class="notifs-label">Team</div>
            <h4 class="notifs-title mb-0">Staff</h4>
            <p class="notifs-sub mb-0">Manage all registered staff members</p>
        </div>
        <button class="n-btn n-btn-primary" data-bs-toggle="modal" data-bs-target="#addStaffModal">
            <i class="fa fa-user-plus"></i> Add Staff
        </button>
    </div>

    <!-- Filter -->
    <form hx-get="{{ route('staff') }}" hx-target="#staff-table" hx-push-url="true"
        ...
        <a href="{{ route('staff') }}" class="n-btn n-btn-secondary text-decoration-none" hx-get="{{ route('staff') }}"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content od-modal">
            <div class="od-modal-header">
                <div>
                    <div class="od-order-num">Staff Details</div>
                    <div class="od-order-sub">Viewing staff profile</div>
                </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content od-modal">
            <form method="POST" id="editStaffForm">
                ...
                <div class="od-modal-header">
                    <div>
                        <div class="od-order-num">Edit Staff</div>
                        <div class="od-order-sub">Update staff member details</div>
                    </div>
                    <button type="button" class="od-close" data-bs-dismiss="modal"><i class="fa fa-xmark"></i></button>
                </div>
                <div class="od-modal-body">
                ...
                <div class="od-modal-footer">
                    ...
                    <button type="submit" class="n-btn n-btn-primary"><i class="fa fa-floppy-disk me-1"></i> Update
                        Staff</button>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content od-modal">
            <form method="POST" action="{{ route('staff.store') }}">
                ...
                <div class="od-modal-header">
                    <div>
                        <div class="od-order-num">Add Staff</div>
                        <div class="od-order-sub">Create a new staff account</div>
                    </div>
                ...
                <div class="od-modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="p-label">Phone</label>
                            <input type="tel" name="phone" class="p-input" placeholder="+1 000 000 0000">
                        </div>
                        <div class="col-md-6">
                            <label class="p-label">Address</label>
                            <input type="text" name="address" class="p-input" placeholder="123 Main St">
                        </div>
                        <div class="col-md-6">
                            <label class="p-label">Password</label>
                            <div class="pw-wrap">
                                <input type="password" name="password" id="addStaffPassword" class="p-input"
                                    required>
                ...
                <div class="od-modal-footer">
                    <button type="button" class="n-btn n-btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="n-btn n-btn-primary"><i class="fa fa-user-plus me-1"></i> Create
                        Staff</button>
                </div>
            </form>
        </div>
            ...
            <form method="POST" id="editStaffForm">
                ...
                <div class="od-modal-footer">
                    ...
                    <button type="submit" class="n-btn n-btn-primary">
                        <i class="fa fa-floppy-disk me-1"></i> Update Staff
                    </button>
                </div>
            </form>
        </div>
        ...
        <div class="modal-content od-modal">
            <form method="POST" action="{{ route('staff.store') }}">
                ...
                <div class="od-modal-footer">
                    <button type="button" class="n-btn n-btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="n-btn n-btn-primary">
                        <i class="fa fa-user-plus me-1"></i> Create Staff
                    </button>
                </div>
            </form>
        </div>
