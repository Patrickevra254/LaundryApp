 ...
 <div class="container-fluid">
    ...
    <form hx-get="{{ route('customer') }}" hx-target="#customer-table" hx-push-url="true"
        ...
        <a href="{{ route('customer') }}" class="n-btn n-btn-secondary text-decoration-none"
            hx-get="{{ route('customer') }}" hx-target="#content-area" hx-swap="innerHTML"
            ...
            <div class="modal-content od-modal">
                <form method="POST" id="editCustomerForm">
                    ...
                    <div class="od-modal-footer">
                        ...
                        <button type="submit" class="n-btn n-btn-primary"><i class="fa fa-floppy-disk me-1"></i> Update Customer</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <form method="POST" action="{{ route('customer.store') }}">
                    ...
                    <div class="od-modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="p-label">Email</label>
                                <input type="email" name="email" class="p-input" placeholder="name@example.com" required>
                            </div>
                            <div class="col-md-6">
                                <label class="p-label">Phone</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="pw-wrap">
                                    <input type="password" name="password" id="addCustomerPassword" class="p-input" required>
                                    <button type="button" class="pw-toggle" onclick="togglePassword('addCustomerPassword', this)">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="pw-wrap">
                                    <input type="password" name="password_confirmation" id="addCustomerConfirmPassword" class="p-input" required>
                                    <button type="button" class="pw-toggle" onclick="togglePassword('addCustomerConfirmPassword', this)">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="od-modal-footer">
                        <button type="button" class="n-btn n-btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="n-btn n-btn-primary"><i class="fa fa-user-plus me-1"></i> Add Customer</button>
                    </div>
                </form>
            </div>
        </div>
