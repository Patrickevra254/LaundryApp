                ...
                <div class="modal-content od-modal">
                    <form method="POST" id="editItemForm">
                        ...
                        <div class="od-modal-header">
                            ...
                            <button type="button" class="od-close" data-bs-dismiss="modal">
                        ...
                        <div class="od-modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <label class="p-label">Washing Price (₦)</label>
                                    <input type="number" name="washing_price" id="edit-washing_price" class="p-input"
                                        required>
                                </div>
                                <div class="col-md-4">
                                    <label class="p-label">Ironing Price (₦)</label>
                                    <input type="number" name="ironing_price" id="edit-ironing_price" class="p-input"
                                        required>
                                </div>
                                <div class="col-md-4">
                                    <label class="p-label">Wash & Iron Price (₦)</label>
                                    <input type="number" name="wash_and_iron_price" id="edit-wash_and_iron_price"
                                        class="p-input" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="p-label">
                                        <i class="fa fa-clock me-1" style="color:#4f46e5;"></i> Due Days
                                        <span style="color:#9ca3af;font-weight:400;"> (days to complete)</span>
                                    </label>
                                    <input type="number" name="due_days" id="edit-due_days" class="p-input"
                                        min="1" placeholder="e.g. 2">
                                    <div style="font-size:.72rem;color:#9ca3af;margin-top:3px;">
                                        Number of days this item takes to be ready after pickup.
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="p-label">Status</label>
                    ...
                    <div class="od-modal-body">
                        <form action="{{ route('laundry-items.store') }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <label class="p-label">Washing Price (₦)</label>
                                    <input type="number" name="washing_price" class="p-input" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="p-label">Ironing Price (₦)</label>
                                    <input type="number" name="ironing_price" class="p-input" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="p-label">Wash & Iron Price (₦)</label>
                                    <input type="number" name="wash_and_iron_price" class="p-input" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="p-label">
                                        <i class="fa fa-clock me-1" style="color:#4f46e5;"></i> Due Days
                                    ...
                                    <input type="number" name="due_days" class="p-input" min="1"
                                        value="1" required>
                                    <div style="font-size:.72rem;color:#9ca3af;margin-top:3px;">
                                        Number of days this item takes to be ready after pickup.
                                    </div>
                            ...
                            <div class="od-modal-footer mt-3 px-0 pb-0">
                                <button type="button" class="n-btn n-btn-secondary"
                                    data-bs-dismiss="modal">Cancel</button>
                                <button type="submit" class="n-btn n-btn-primary">
                                    <i class="fa fa-floppy-disk me-1"></i> Save Item
                                </button>
                            </div>
                        </form>
                    </div>
                ...
                btn.addEventListener('click', function() {
                    fetch(`/laundry-items/${this.dataset.id}`)
                        ...
                        .then(item => {
                            ...
                            document.getElementById('edit-wash_and_iron_price').value = item
                                .wash_and_iron_price;
                            document.getElementById('edit-due_days').value = item.due_days ?? 1;
                            document.getElementById('edit-status').value = item.is_active;
                            document.querySelectorAll('#editItemModal input[name="icon"]').forEach(r =>
                                r.checked = (r.value === item.icon));
                            document.getElementById('editItemForm').action =
