            ...
            <div class="modal-content od-modal">
                ...
                <div class="od-modal-body">
                    ...
                    <div class="od-info-grid mb-4">
                        ...
                        {{-- Staff Assignment (only shown if set) --}}
                        @if (
                            $order->wash_assigned_to ||
                                $order->iron_assigned_to ||
                                $order->packed_by ||
                                $order->reviwed_by ||
                                $order->collector_name ||
                                $order->collector_phone ||
                            ...
                            <div class="od-info-card">
                                <div class="od-info-label"><i class="fa fa-fire me-1" style="color:#f59e0b;"></i>
                                    Packed By</div>
                                <div class="od-info-value">{{ $order->packed_by ?: '—' }}</div>
                            </div>
                            <div class="od-info-card">
                                <div class="od-info-label"><i class="fa fa-fire me-1" style="color:#f59e0b;"></i>
                                    Reviewed by</div>
                                <div class="od-info-value">{{ $order->reviewed_by ?: '—' }}</div>
                            </div>
                            <div class="od-info-card">
                                <div class="od-info-label"><i class="fa fa-fire me-1" style="color:#f59e0b;"></i>
                    ...
                    <form method="POST" action="{{ route('orders.updateDetails', $order->id) }}">
                        ...
                        <div class="od-modal-body">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    <label class="p-label">
                                        <i class="fa fa-box me-1" style="color:#8b5cf6;"></i> Packer
                                    </label>
                                    <input type="text" name="packed_by" class="p-input"
                                        value="{{ $order->packed_by }}" placeholder="Enter name of packer">
                                </div>
                                <div class="col-md-6">
                                    <label class="p-label">
                                        <i class="fa fa-clipboard-check me-1" style="color:#10b981;"></i> Reviewer
                                    </label>
                                    <input type="text" name="reviewed_by" class="p-input"
                                        value="{{ $order->reviewed_by }}" placeholder="Enter name of reviewer">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-12">
                                    <div class="edit-section-label">
                                        <i class="fa fa-hand-holding me-1"></i> Collection Details
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="p-label">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="partial-input-wrap">
                                        ...
                                        {{-- <input type="number" name="extra_charges" class="p-input" min="0"
                                            value="{{ $order->extra_charges ?? 0 }}" placeholder="0"> --}}
                                        <input type="number" name="extra_charges" class="p-input" min="0"
                                            @if ($order->extra_charges) value="{{ $order->extra_charges }}"
                                            @else
                                            value="" @endif
                                            placeholder="0">
                                    </div>
    ...
    function openPrintWindow(content) {
        ...
        if (!win) {
            Swal.fire({
                ...
                text: 'Please allow pop-ups for this site to print invoices.',
